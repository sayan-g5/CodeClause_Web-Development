...
var questions = [
    ...
    {
        question: "Which is the first cricket team to play 1000 ODI matches?",
        answer: "India",
        options: [
            "Australia",
            "India",
...
function appendResult() {
    ...
    for (var i = 0; i < questions.length; i++) {
        if (answers[i]) {
            divBody += "<td><img style='width:30px' src='Images/accept.png'></td>"
            correctQuestions++
        }
        else divBody += "<td><img style='width:30px' src='Images/close.png'></td>"
    }
    divBody += "</tbody></table>"
...
function loginButton() {
    ...
    if (username.value === "Sayan" && password.value === "1803") {
